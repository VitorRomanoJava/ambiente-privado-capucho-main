// Arquivo: src/components/3d/TshirtViewer.tsx
...
export const TshirtViewer = (props: CommonViewerProps) => {
  ...
  return (
    <Canvas id="product-canvas" camera={{ position: [0, 0, 3.5], fov: 30 }} shadows>
